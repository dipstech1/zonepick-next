                ...
                <div className="container">
                            ...
                            <img src="./img/profile_pic.png" className="m-auto mr-lg-auto" />
                                <div className="ed_img dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li><a className="dropdown-item" onClick={changePic}>Change Profile Photo</a></li>
                    ...
                    <div className="row m-0 justify-content-center">
                        <div className="col-12 col-lg-8 p-0">
                            <form className="row m-0 edit_userform">
                                <div className="col-12 col-lg-6">
                                    <label>Name</label>
                                    <input onChange={updateValue} name="name" type="text" value={userData.name} className="form-control" placeholder="Full name" />
                                </div>
                                <div className="col-12 col-lg-6">
                                    <label>Phone Number</label>
                                    <input onChange={updateValue} name="phone" type="number" value={userData.phone} className="form-control" placeholder="Phone no." />
                                </div>
                                <div className="col-12 col-lg-6">
                                    <label>Address</label>
                                    <input onChange={updateValue} name='address1' type="text" value={userData.address1} className="form-control" placeholder="Address1" />
                                </div>
                                <div className="col-12 col-lg-6">
                                    <label>Address2</label>
                                    <input onChange={updateValue} name='address2' type="text" value={userData.address2} className="form-control" placeholder="Address2" />
                                </div>
                                <div className="col-12 col-lg-6">
                                    <label>Addres3</label>
                                    <input onChange={updateValue} name='address3' type="text" value={userData.address3} className="form-control" placeholder="Address3" />
                                </div>
                                <div className="col-12 col-lg-6">
                                    <label>About Me</label>
                                    <textarea name='aboutme' type="text" className="form-control h-auto" rows="3" placeholder="About me"></textarea>
                                </div>
                                <div className="col-12 col-lg-6">
                                    <label>Email ID</label>
                                    <input onChange={updateValue} name='email' type="email" value={userData.email}  className="form-control" placeholder="abc@gmail.com" />
                                </div>
                                <div className="col-12 col-lg-5 mt-4">
                                    <p>Connected Account: <a href="javascript:void(0);"><img src="./img/google.svg" width="60px" /></a></p>
                                </div>
                                <div className="col-12 col-lg-5 mt-4">
                                    <button className="btn btn-outline-warning dcc btn-sm ms-lg-4">DISCONNECT</button>
                                </div>
                                <div className="col-12 fbutton mt-4">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <button className="btn btn-outline-warning btn-sm ms-lg-4">Discard</button>
