  ...
  return (
    <>
      <Layout
        ...
        showNav={false}
        showFooter={false}
        metaDescription={[{ name: 'description', content: 'Login' }]}
      >
                      ...
                      <div className="p-2 ps-5 pe-5">
                        <Row className="mb-3">
                          <Col className="text-center ">
                            <Image src="/logo/logo.png" alt="Logo" width={120} height={70}></Image>
                          </Col>
                        </Row>
                            ...
                            <Form onSubmit={formik.handleSubmit}>
                              ...
                              <Form.Group controlId="submitButton" className="d-grid gap-2 ps-3 pe-3">
                                <Button variant="deep-purple-900" type="submit" className="text-white">
                                  Login
                                  {submitted ? (
                                    <span className="spinner-border spinner-border-sm me-1 ms-2"></span>
                                  ) : null}
                                </Button>
                              </Form.Group>
                            </Form>
