...
const ItemListPage = () => {
  ...
  const initLoader = () => {
    ...
    hlight = new THREE.AmbientLight(0xffffff, 0.1);
    scene.add(hlight);
    ...
    scene.add(light1);
    light2 = new THREE.PointLight(0xffffff, 0.01);
    ...
    loader1.load(modelPath_2, function (object) {
      object.scale.set(0.75, 0.75, 0.75);
      object.position.set(105, -140, -100);
  ...
  return (
    <Layout title="Furniture Shop" showFooter={false} showNav={false}>
