...
const ItemListPage = () => {
  ...
  function onMouseDown(e) {
    ...
    if (intersects && intersects[0]) {
      ...
      if (intersects[0].object.name.includes("tshirt")) {
        router.push("fashion-shop/view?modelName=tshirt.fbx&set=1");
  ...
  return (
    <Layout title="Fashion Shop" showFooter={false} showNav={false}>
