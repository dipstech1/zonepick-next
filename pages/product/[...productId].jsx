                ...
                <Row className="mt-3">
                  <Col md={showSellerInfo === true ? 8 : 12}>
                    <ImageViewer
                      ...
                      arImageUrl={ productDetails?.product?.arimageurl.includes(".glb") ? common.arUrl + productDetails?.product?.arimageurl : common.arUrl_fbx + productDetails?.product?.arimageurl}
