...
const ImageList = ({ maxUpload = 2, info = "", onSelectionChanged, id = "xv", imagesList = [] }) => {
                        ...
                        <Col xs={6} lg={4} key={i}>
                            <div className="uploader-container border border-danger mb-2">
                                <div className="pe-1 pt-1 pb-1 image-container">
                                    <img src={`https://www.emetacomm.com/upload_doc/images/${link}`} alt={"xx"} className="img-responsive-uploader" />
